...
def save_digest_config(payload: DigestConfigPayload) -> dict:
    ...
    repo.set_setting("digest.target_items", str(payload.target_items))
    repo.set_setting("digest.min_per_category", str(payload.min_per_category))
    repo.set_setting("digest.max_per_category", str(payload.max_per_category))
    repo.set_setting("digest.max_per_source", str(payload.max_per_source))
